  ...
  return (
    <div className="w-full grid grid-cols-1 divide-y divide-gray-300">
      ...
      <div className="w-full pb-16">
        ...
        <div className="w-full h-1/5 px-16">
            ...
            <div className="w-full h-full flex mt-16 px-16">
              ...
              <div className="h-full w-3/6 pt-16">
                <div>
                  <p className="text-gray-900 flex justify-center font-semibold text-4xl text-left">
                    Build meaningful <br />
                    &amp; long lasting <br /> relationship with your <br />{" "}
                    brand ambassadors
                  </p>
                  <p className="pt-6 text-left text-gray-900 flex justify-center">
                    Make things faster. Pin tabs to automatically
          ...
          <div className="w-full h-screen">
            <div className="w-full h-3/6 bg-gray-500 mt-16 rounded-xl">
              <div className=" h-3/5 flex items-center justify-center">
                <p className="font-bold text-4xl w-2/6 text-white">
                  Reach up to thousands of collaborations/month with just one
                  person
                </p>
              </div>
              <div className="h-1/3 flex items-center justify-center">
                <a
                  href="/#"
                  className="bg-gray-900 text-white py-3 px-5 rounded-md"
                >
